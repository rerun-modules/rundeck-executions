...
# Created: Tue Dec 22 09:02:43 PST 2015
#
#/ usage: rundeck-executions:query  --project <> [ --status-filter <>] [ --abortedby-filter <>] [ --user-filter <>] [ --recent-filter <>] [ --begin <>] [ --end <>] [ --adhoc <>]  --url <$RUNDECK_URL> [ --username <$RUNDECK_USER>] [ --password <$RUNDECK_PASSWORD>] [ --apikey <$RUNDECK_APIKEY>] [ --max <20>] [ --offset <0>] [ --job-filter <>] [ --long <true>] [ --file <>] 
